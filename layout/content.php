...
$NUM->execute();
$NUMS = $NUM->fetch(PDO::FETCH_ASSOC);
$masuk = $NUMS['jumlah_vote'];
						...
						<div class="agileits-box">
							...
							<div class="agileits-box-body clearfix">
								...
								<p align="center">
									...
									untuk mencari calon Ketua OSIS di SMPN1 Maesan Bondowoso Tahun Periode 2024/2025.
								</p>
								<style type="text/css">
									;

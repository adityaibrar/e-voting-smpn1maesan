...
?>
		<script type="text/javascript">
			$(document).ready(function() {
				swal({
						title: "Selamat!",
						text: "Berhasil mengupdate setting waktu",
						type: "success"
					},
					function() {
	...
	<?php
		...
		<script type="text/javascript">
			$(document).ready(function() {
				swal({
						title: "Maaf!",
						text: "Gagal mengupdate setting waktu",
						type: "error"
					},
					function() {
						document.location = 'index.php'
					...
					<div class="col-sm-12">
						<div class="table-responsive">
							<table class="table table-striped b-t b-light">
								<thead>
									<tr>
										<th style="width:20px; font-family: 'Poppins', sans-serif;">ID Waktu</th>
										<th>Waktu</th>
										<th>Action</th>
									</tr>
								</thead>
									...
									?>
											<tr>
												...
												<td><button type="button" class="btn btn-danger btn-sm" role="button" aria-pressed="true" data-toggle="modal" data-target="#updateSetWaktu<?php print($row['id_setting']); ?>">
														<i class="fa fa-calendar"> <span style="font-family: 'Poppins', sans-serif;">&nbsp; Ganti Waktu</span></i>
													</button></td>
											</tr>
